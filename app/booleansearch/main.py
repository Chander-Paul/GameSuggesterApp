...
def main(text=None):
    ...
    if not text:
        text = "I want to unload bullets into swarms of dudes- what do you suggest. Generally, do not want much more than that, hordes of dudes and a big ass gun. Don't need depth, don't need strategy, don't need to explore. Just want to unwind with massive waves of things to gun down."
    text = "I like playing strategy and 4x games. Generally, don't want horror games."
